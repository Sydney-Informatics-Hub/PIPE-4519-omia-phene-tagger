# -*- coding: utf-8 -*-
"""
Originally created on Thu Jun 11 09:02:24 2020
...
def build_dict(hpofile, outpath, rootnode):
    ...
    for i in range(0, len(all_obo)):
        ...
        if first_name != []:
            hpo_obo[hpoid] = {'name': first_name, 'alt_id': alt_id_list, 'def': def_string, 'synonym': synonym_list,
                              'xref': xref_list, 'is_a': isa_list, 'is_obsolete': is_obsolete, 'replace_id': replace_id}
...
if __name__ == "__main__":
    ...
    parser.add_argument('--rootnode', '-r', help="input the root node of the ontogyly", nargs='+',
                        default=['HP:0000118'])  # HP:0000118 MESH:C CHEBI:24431
