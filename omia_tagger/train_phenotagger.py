...
if __name__=="__main__":
    ...
    parser = argparse.ArgumentParser(
        description='train PhenoTagger, python PhenoTagger_training.py -t trainfile -d devfile -m modeltype -o outpath',
    )
    ...
    if args.modeltype=='cnn':
        vocabfiles={'w2vfile':'../models/bio_embedding_intrinsic.d200',   
                    'charfile': os.path.join(vocab_dir, 'char.vocab'),
                    'labelfile': os.path.join(vocab_dir, 'lable.vocab'),
                    'posfile': os.path.join(vocab_dir, 'pos.vocab')}
        ...
        vocabfiles={'labelfile': os.path.join(vocab_dir, 'lable.vocab'),
